...
const { loadMessage, getAnti } = require('../lib/database2');
...
*╰💬 ᴅᴇʟᴇᴛᴇᴅ ᴍsɢ:*↡`;
                    jid = settings.ANTI_DEL_PATH === "public" ? conn.user.id : store.jid;
                } else {
...
┊⚠️ ᴀᴄᴛɪᴏɴ:* _ᴅᴇʟᴇᴛᴇᴅ ᴀ ᴍᴇssᴀɢᴇ_
╰💬 ᴅᴇʟᴇᴛᴇᴅ ᴍsɢ:↓* `;
                    jid = config.ANTI_DEL_PATH === "public" ? conn.user.id : update.key.remoteJid;
                }
